...
public class WebView2 : HwndHost
{
	...
	protected override void OnRender(DrawingContext dc)
	{
		...
		FormattedText formattedText = new FormattedText("WebView2", CultureInfo.CurrentCulture, FlowDirection.LeftToRight, typeface, 20.0, solidColorBrush);
	...
	{
		WebView2KeyEventArgs e2 = new WebView2KeyEventArgs(Keyboard.PrimaryDevice, PresentationSource.FromDependencyObject(this), System.Environment.TickCount, KeyInterop.KeyFromVirtualKey((int)e.VirtualKey))
		{
