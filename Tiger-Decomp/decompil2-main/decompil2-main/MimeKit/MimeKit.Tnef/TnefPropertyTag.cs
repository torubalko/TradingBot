...
public struct TnefPropertyTag
{
	...
	public static readonly TnefPropertyTag Business2TelephoneNumberAMv = new TnefPropertyTag(TnefPropertyId.Business2TelephoneNumber, TnefPropertyType.String8, multiValue: true);
	...
	public static readonly TnefPropertyTag Business2TelephoneNumberWMv = new TnefPropertyTag(TnefPropertyId.Business2TelephoneNumber, TnefPropertyType.Unicode, multiValue: true);
	...
	public static readonly TnefPropertyTag ChildrensNamesA = new TnefPropertyTag(TnefPropertyId.ChildrensNames, TnefPropertyType.String8, multiValue: true);

	public static readonly TnefPropertyTag ChildrensNamesW = new TnefPropertyTag(TnefPropertyId.ChildrensNames, TnefPropertyType.Unicode, multiValue: true);
	...
	public static readonly TnefPropertyTag ContactAddrtypesA = new TnefPropertyTag(TnefPropertyId.ContactAddrtypes, TnefPropertyType.String8, multiValue: true);

	public static readonly TnefPropertyTag ContactAddrtypesW = new TnefPropertyTag(TnefPropertyId.ContactAddrtypes, TnefPropertyType.Unicode, multiValue: true);
	...
	public static readonly TnefPropertyTag ContactEntryIds = new TnefPropertyTag(TnefPropertyId.ContactEntryIds, TnefPropertyType.Binary, multiValue: true);
	...
	public static readonly TnefPropertyTag ContentsSortOrder = new TnefPropertyTag(TnefPropertyId.ContentsSortOrder, TnefPropertyType.Long, multiValue: true);
	...
	public static readonly TnefPropertyTag FormHostMap = new TnefPropertyTag(TnefPropertyId.FormHostMap, TnefPropertyType.Long, multiValue: true);
	...
	public static readonly TnefPropertyTag Home2TelephoneNumberAMv = new TnefPropertyTag(TnefPropertyId.Home2TelephoneNumber, TnefPropertyType.String8, multiValue: true);
	...
	public static readonly TnefPropertyTag Home2TelephoneNumberWMv = new TnefPropertyTag(TnefPropertyId.Home2TelephoneNumber, TnefPropertyType.Unicode, multiValue: true);
	...
	public static readonly TnefPropertyTag MobileTelephoneNumberA = new TnefPropertyTag(TnefPropertyId.CellularTelephoneNumber, TnefPropertyType.String8);

	public static readonly TnefPropertyTag MobileTelephoneNumberW = new TnefPropertyTag(TnefPropertyId.CellularTelephoneNumber, TnefPropertyType.Unicode);
	...
	public static readonly TnefPropertyTag Office2TelephoneNumberA = new TnefPropertyTag(TnefPropertyId.Business2TelephoneNumber, TnefPropertyType.String8);

	public static readonly TnefPropertyTag Office2TelephoneNumberW = new TnefPropertyTag(TnefPropertyId.Business2TelephoneNumber, TnefPropertyType.Unicode);
	...
	public static readonly TnefPropertyTag PagerTelephoneNumberA = new TnefPropertyTag(TnefPropertyId.BeeperTelephoneNumber, TnefPropertyType.String8);

	public static readonly TnefPropertyTag PagerTelephoneNumberW = new TnefPropertyTag(TnefPropertyId.BeeperTelephoneNumber, TnefPropertyType.Unicode);
	...
	public static readonly TnefPropertyTag PostalCodeA = new TnefPropertyTag(TnefPropertyId.BusinessAddressPostalCode, TnefPropertyType.String8);

	public static readonly TnefPropertyTag PostalCodeW = new TnefPropertyTag(TnefPropertyId.BusinessAddressPostalCode, TnefPropertyType.Unicode);
	...
	public static readonly TnefPropertyTag PostOfficeBoxA = new TnefPropertyTag(TnefPropertyId.BusinessAddressPostOfficeBox, TnefPropertyType.String8);

	public static readonly TnefPropertyTag PostOfficeBoxW = new TnefPropertyTag(TnefPropertyId.BusinessAddressPostOfficeBox, TnefPropertyType.Unicode);
	...
	public static readonly TnefPropertyTag ReferredByNameA = new TnefPropertyTag(TnefPropertyId.PreferredByName, TnefPropertyType.String8);

	public static readonly TnefPropertyTag ReferredByNameW = new TnefPropertyTag(TnefPropertyId.PreferredByName, TnefPropertyType.Unicode);
	...
	public static readonly TnefPropertyTag StateOrProvinceA = new TnefPropertyTag(TnefPropertyId.BusinessAddressStateOrProvince, TnefPropertyType.String8);

	public static readonly TnefPropertyTag StateOrProvinceW = new TnefPropertyTag(TnefPropertyId.BusinessAddressStateOrProvince, TnefPropertyType.Unicode);
	...
	private const TnefPropertyId NamedMin = (TnefPropertyId)(-32768);

	private const TnefPropertyId NamedMax = (TnefPropertyId)(-2);

	private const short MultiValuedFlag = 4096;

	private readonly TnefPropertyType type;

	private readonly TnefPropertyId id;

	public TnefPropertyId Id => id;

	public bool IsMultiValued => (type & TnefPropertyType.MultiValued) != 0;

	public bool IsNamed
	{
		get
		{
			if (id >= (TnefPropertyId)(-32768))
			{
				return id <= (TnefPropertyId)(-2);
			}
			return false;
		}
	}
	...
	public TnefPropertyType TnefType => type;

	public TnefPropertyType ValueTnefType => type & (TnefPropertyType)(-4097);
	...
	{
		this.type = (TnefPropertyType)((ushort)type | (multiValue ? 4096 : 0));
		this.id = id;
	}
	...
	{
		if (!(obj is TnefPropertyTag tnefPropertyTag))
		{
			return false;
		}
		if (tnefPropertyTag.Id == Id)
		{
			return tnefPropertyTag.TnefType == TnefType;
		}
		return false;
	}
	...
	{
		TnefPropertyType tnefPropertyType = (type & TnefPropertyType.MultiValued) | TnefPropertyType.Unicode;
		return new TnefPropertyTag(id, tnefPropertyType);
	}
}
