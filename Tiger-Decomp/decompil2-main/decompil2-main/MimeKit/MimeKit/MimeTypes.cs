...
public static class MimeTypes
{
	...
	private static Dictionary<string, string> LoadExtensions()
	{
		return new Dictionary<string, string>(MimeUtils.OrdinalIgnoreCase)
		{
	...
	public static string GetMimeType(string fileName)
	{
		...
		mimeTypes.TryGetValue(extension, out var value);
	...
	public static void Register(string mimeType, string extension)
	{
		...
		{
			throw new ArgumentException("Cannot register an empty MIME-type.", "mimeType");
		}
		if (extension == null)
		{
		...
		{
			throw new ArgumentException("Cannot register an empty file extension.", "extension");
		}
		if (extension[0] != '.')
		{
			extension = "." + extension;
