...
public class TimeStampResponse
{
	...
	public void Validate(TimeStampRequest request)
	{
		...
		if (tok != null)
		{
			...
			Org.BouncyCastle.Asn1.Cms.Attribute attribute = tok.SignedAttributes[PkcsObjectIdentifiers.IdAASigningCertificate];
			Org.BouncyCastle.Asn1.Cms.Attribute scV2 = tok.SignedAttributes[PkcsObjectIdentifiers.IdAASigningCertificateV2];
			if (attribute == null && scV2 == null)
			{
