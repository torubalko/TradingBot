...
public class TimeStampRequestGenerator
{
	...
	public TimeStampRequest Generate(string digestAlgorithmOid, byte[] digest, BigInteger nonce)
	{
		...
		return new TimeStampRequest(new TimeStampReq(nonce: (nonce == null) ? null : new DerInteger(nonce), messageImprint: messageImprint, tsaPolicy: reqPolicy, certReq: certReq, extensions: ext));
	}
