...
public class ProfessionInfo : Asn1Encodable
{
	...
	private ProfessionInfo(Asn1Sequence seq)
	{
		...
		if (o is Asn1TaggedObject)
		{
			...
			namingAuthority = NamingAuthority.GetInstance(ato, isExplicit: true);
			e.MoveNext();
	...
	public override Asn1Object ToAsn1Object()
	{
		...
		v.AddOptionalTagged(isExplicit: true, 0, namingAuthority);
		v.Add(professionItems);
		v.AddOptional(professionOids);
		if (registrationNumber != null)
		{
			v.Add(new DerPrintableString(registrationNumber, validate: true));
		}
