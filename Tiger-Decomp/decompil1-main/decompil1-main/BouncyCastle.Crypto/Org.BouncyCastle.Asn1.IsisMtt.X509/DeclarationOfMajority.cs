...
public class DeclarationOfMajority : Asn1Encodable, IAsn1Choice
{
	...
	public DeclarationOfMajority(bool fullAge, string country)
	{
		...
		DerPrintableString countryString = new DerPrintableString(country, validate: true);
		declaration = new DerTaggedObject(explicitly: false, 1, (!fullAge) ? new DerSequence(DerBoolean.False, countryString) : new DerSequence(countryString));
	}
