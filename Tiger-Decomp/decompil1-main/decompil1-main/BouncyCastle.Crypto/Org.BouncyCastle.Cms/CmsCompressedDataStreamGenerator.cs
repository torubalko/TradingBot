...
public class CmsCompressedDataStreamGenerator
{
	...
	public Stream Open(Stream outStream, string contentOID, string compressionOID)
	{
		...
		BerSequenceGenerator cGen = new BerSequenceGenerator(sGen.GetRawOutputStream(), 0, isExplicit: true);
		...
		return new CmsCompressedOutputStream(new ZOutputStream(CmsUtilities.CreateBerOctetOutputStream(eiGen.GetRawOutputStream(), 0, isExplicit: true, _bufferSize), -1), sGen, cGen, eiGen);
	}
}
