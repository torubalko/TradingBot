...
public class AuthEnvelopedData : Asn1Encodable
{
	...
	private AuthEnvelopedData(Asn1Sequence seq)
	{
		...
		{
			tmp = seq[index++].ToAsn1Object();
			unauthAttrs = Asn1Set.GetInstance((Asn1TaggedObject)tmp, explicitly: false);
		}
	}
	...
	public override Asn1Object ToAsn1Object()
	{
		...
		v.AddOptionalTagged(isExplicit: false, 1, authAttrs);
		v.Add(mac);
		v.AddOptionalTagged(isExplicit: false, 2, unauthAttrs);
