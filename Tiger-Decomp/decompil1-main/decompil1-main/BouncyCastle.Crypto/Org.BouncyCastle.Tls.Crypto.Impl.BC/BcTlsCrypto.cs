...
public class BcTlsCrypto : AbstractTlsCrypto
{
	...
	{
		BcChaCha20Poly1305 encrypt = new BcChaCha20Poly1305(isEncrypting: true);
		BcChaCha20Poly1305 decrypt = new BcChaCha20Poly1305(isEncrypting: false);
		return new TlsAeadCipher(cryptoParams, encrypt, decrypt, 32, 16, 2);
	}

	protected virtual TlsAeadCipher CreateCipher_Aes_Ccm(TlsCryptoParameters cryptoParams, int cipherKeySize, int macSize)
	{
		BcTlsAeadCipherImpl encrypt = new BcTlsAeadCipherImpl(CreateAeadBlockCipher_Aes_Ccm(), isEncrypting: true);
		BcTlsAeadCipherImpl decrypt = new BcTlsAeadCipherImpl(CreateAeadBlockCipher_Aes_Ccm(), isEncrypting: false);
	...
	{
		BcTlsAeadCipherImpl encrypt = new BcTlsAeadCipherImpl(CreateAeadBlockCipher_Aes_Gcm(), isEncrypting: true);
		BcTlsAeadCipherImpl decrypt = new BcTlsAeadCipherImpl(CreateAeadBlockCipher_Aes_Gcm(), isEncrypting: false);
	...
	{
		BcTlsAeadCipherImpl encrypt = new BcTlsAeadCipherImpl(CreateAeadBlockCipher_Aria_Gcm(), isEncrypting: true);
		BcTlsAeadCipherImpl decrypt = new BcTlsAeadCipherImpl(CreateAeadBlockCipher_Aria_Gcm(), isEncrypting: false);
		return new TlsAeadCipher(cryptoParams, encrypt, decrypt, cipherKeySize, macSize, 3);
	}

	protected virtual TlsAeadCipher CreateCipher_Camellia_Gcm(TlsCryptoParameters cryptoParams, int cipherKeySize, int macSize)
	{
		BcTlsAeadCipherImpl encrypt = new BcTlsAeadCipherImpl(CreateAeadBlockCipher_Camellia_Gcm(), isEncrypting: true);
		BcTlsAeadCipherImpl decrypt = new BcTlsAeadCipherImpl(CreateAeadBlockCipher_Camellia_Gcm(), isEncrypting: false);
		return new TlsAeadCipher(cryptoParams, encrypt, decrypt, cipherKeySize, macSize, 3);
	}
	...
	{
		BcTlsBlockCipherImpl encrypt = new BcTlsBlockCipherImpl(CreateCbcBlockCipher(encryptionAlgorithm), isEncrypting: true);
		BcTlsBlockCipherImpl decrypt = new BcTlsBlockCipherImpl(CreateCbcBlockCipher(encryptionAlgorithm), isEncrypting: false);
	...
	{
		BcTlsAeadCipherImpl encrypt = new BcTlsAeadCipherImpl(CreateAeadBlockCipher_SM4_Ccm(), isEncrypting: true);
		BcTlsAeadCipherImpl decrypt = new BcTlsAeadCipherImpl(CreateAeadBlockCipher_SM4_Ccm(), isEncrypting: false);
	...
	{
		BcTlsAeadCipherImpl encrypt = new BcTlsAeadCipherImpl(CreateAeadBlockCipher_SM4_Gcm(), isEncrypting: true);
		BcTlsAeadCipherImpl decrypt = new BcTlsAeadCipherImpl(CreateAeadBlockCipher_SM4_Gcm(), isEncrypting: false);
	...
	public override TlsSrp6Client CreateSrp6Client(TlsSrpConfig srpConfig)
	{
		...
		srp6Client.Init(srpGroup, CreateDigest(2), SecureRandom);
	...
	public override TlsSrp6Server CreateSrp6Server(TlsSrpConfig srpConfig, BigInteger srpVerifier)
	{
		...
		srp6Server.Init(srpGroup, srpVerifier, CreateDigest(2), SecureRandom);
