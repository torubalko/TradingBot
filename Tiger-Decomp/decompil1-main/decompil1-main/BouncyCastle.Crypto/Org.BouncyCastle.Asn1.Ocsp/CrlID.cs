...
public class CrlID : Asn1Encodable
{
	...
	public CrlID(Asn1Sequence seq)
	{
		foreach (Asn1TaggedObject o in seq)
		{
			...
			{
			case 0:
				crlUrl = DerIA5String.GetInstance(o, isExplicit: true);
				break;
			case 1:
				crlNum = DerInteger.GetInstance(o, isExplicit: true);
				break;
			case 2:
				crlTime = DerGeneralizedTime.GetInstance(o, isExplicit: true);
				break;
			default:
