...
public sealed class X962NamedCurves
{
	internal class Prime192v1Holder : X9ECParametersHolder
	{
		...
		protected override X9ECParameters CreateParameters()
		{
			...
			ECCurve curve = ConfigureCurve(new FpCurve(FromHex("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFFFFFFFFFF"), FromHex("fffffffffffffffffffffffffffffffefffffffffffffffc"), FromHex("64210519e59c80e70fa7e9ab72243049feb8deecc146b9b1"), n, h));
	...
	internal class Prime192v2Holder : X9ECParametersHolder
	{
		...
		protected override X9ECParameters CreateParameters()
		{
			...
			BigInteger h = BigInteger.One;
			ECCurve curve = ConfigureCurve(new FpCurve(FromHex("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFFFFFFFFFF"), FromHex("fffffffffffffffffffffffffffffffefffffffffffffffc"), FromHex("cc22d6dfb95c6b25e49c0d6364a4e5980c393aa21668d953"), n, h));
	...
	internal class Prime192v3Holder : X9ECParametersHolder
	{
		...
		protected override X9ECParameters CreateParameters()
		{
			...
			BigInteger h = BigInteger.One;
			ECCurve curve = ConfigureCurve(new FpCurve(FromHex("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFFFFFFFFFF"), FromHex("fffffffffffffffffffffffffffffffefffffffffffffffc"), FromHex("22123dc2395a05caa7423daeccc94760a7d462256bd56916"), n, h));
	...
	internal class Prime239v1Holder : X9ECParametersHolder
	{
		...
		protected override X9ECParameters CreateParameters()
		{
			...
			BigInteger h = BigInteger.One;
			ECCurve curve = ConfigureCurve(new FpCurve(new BigInteger("883423532389192164791648750360308885314476597252960362792450860609699839"), FromHex("7fffffffffffffffffffffff7fffffffffff8000000000007ffffffffffc"), FromHex("6b016c3bdcf18941d0d654921475ca71a9db2fb27d1d37796185c2942c0a"), n, h));
	...
	internal class Prime239v2Holder : X9ECParametersHolder
	{
		...
		protected override X9ECParameters CreateParameters()
		{
			...
			BigInteger h = BigInteger.One;
			ECCurve curve = ConfigureCurve(new FpCurve(new BigInteger("883423532389192164791648750360308885314476597252960362792450860609699839"), FromHex("7fffffffffffffffffffffff7fffffffffff8000000000007ffffffffffc"), FromHex("617fab6832576cbbfed50d99f0249c3fee58b94ba0038c7ae84c8c832f2c"), n, h));
	...
	internal class Prime239v3Holder : X9ECParametersHolder
	{
		...
		protected override X9ECParameters CreateParameters()
		{
			...
			BigInteger h = BigInteger.One;
			ECCurve curve = ConfigureCurve(new FpCurve(new BigInteger("883423532389192164791648750360308885314476597252960362792450860609699839"), FromHex("7fffffffffffffffffffffff7fffffffffff8000000000007ffffffffffc"), FromHex("255705fa2a306654b1f4cb03d6a750a30c250102d4988717d9ba15ab6d3e"), n, h));
	...
	internal class Prime256v1Holder : X9ECParametersHolder
	{
		...
		protected override X9ECParameters CreateParameters()
		{
			...
			BigInteger h = BigInteger.One;
			ECCurve curve = ConfigureCurve(new FpCurve(new BigInteger("115792089210356248762697446949407573530086143415290314195533631308867097853951"), FromHex("ffffffff00000001000000000000000000000000fffffffffffffffffffffffc"), FromHex("5ac635d8aa3a93e7b3ebbd55769886bc651d06b0cc53b0f63bce3c3e27d2604b"), n, h));
	...
	internal class C2pnb163v1Holder : X9ECParametersHolder
	{
		...
		protected override X9ECParameters CreateParameters()
		{
			...
			ECCurve curve = ConfigureCurve(new F2mCurve(163, 1, 2, 8, FromHex("072546B5435234A422E0789675F432C89435DE5242"), FromHex("00C9517D06D5240D3CFF38C74B20B6CD4D6F9DD4D9"), n, h));
	...
	internal class C2pnb163v2Holder : X9ECParametersHolder
	{
		...
		protected override X9ECParameters CreateParameters()
		{
			...
			BigInteger h = BigInteger.Two;
			ECCurve curve = ConfigureCurve(new F2mCurve(163, 1, 2, 8, FromHex("0108B39E77C4B108BED981ED0E890E117C511CF072"), FromHex("0667ACEB38AF4E488C407433FFAE4F1C811638DF20"), n, h));
	...
	internal class C2pnb163v3Holder : X9ECParametersHolder
	{
		...
		protected override X9ECParameters CreateParameters()
		{
			...
			BigInteger h = BigInteger.Two;
			ECCurve curve = ConfigureCurve(new F2mCurve(163, 1, 2, 8, FromHex("07A526C63D3E25A256A007699F5447E32AE456B50E"), FromHex("03F7061798EB99E238FD6F1BF95B48FEEB4854252B"), n, h));
	...
	internal class C2pnb176w1Holder : X9ECParametersHolder
	{
		...
		protected override X9ECParameters CreateParameters()
		{
			...
			ECCurve curve = ConfigureCurve(new F2mCurve(176, 1, 2, 43, FromHex("E4E6DB2995065C407D9D39B8D0967B96704BA8E9C90B"), FromHex("5DDA470ABE6414DE8EC133AE28E9BBD7FCEC0AE0FFF2"), n, h));
	...
	internal class C2tnb191v1Holder : X9ECParametersHolder
	{
		...
		protected override X9ECParameters CreateParameters()
		{
			...
			BigInteger h = BigInteger.Two;
			ECCurve curve = ConfigureCurve(new F2mCurve(191, 9, FromHex("2866537B676752636A68F56554E12640276B649EF7526267"), FromHex("2E45EF571F00786F67B0081B9495A3D95462F5DE0AA185EC"), n, h));
	...
	internal class C2tnb191v2Holder : X9ECParametersHolder
	{
		...
		protected override X9ECParameters CreateParameters()
		{
			...
			ECCurve curve = ConfigureCurve(new F2mCurve(191, 9, FromHex("401028774D7777C7B7666D1366EA432071274F89FF01E718"), FromHex("0620048D28BCBD03B6249C99182B7C8CD19700C362C46A01"), n, h));
	...
	internal class C2tnb191v3Holder : X9ECParametersHolder
	{
		...
		protected override X9ECParameters CreateParameters()
		{
			...
			ECCurve curve = ConfigureCurve(new F2mCurve(191, 9, FromHex("6C01074756099122221056911C77D77E77A777E7E7E77FCB"), FromHex("71FE1AF926CF847989EFEF8DB459F66394D90F32AD3F15E8"), n, h));
	...
	internal class C2pnb208w1Holder : X9ECParametersHolder
	{
		...
		protected override X9ECParameters CreateParameters()
		{
			...
			ECCurve curve = ConfigureCurve(new F2mCurve(208, 1, 2, 83, BigInteger.Zero, FromHex("C8619ED45A62E6212E1160349E2BFA844439FAFC2A3FD1638F9E"), n, h));
	...
	internal class C2tnb239v1Holder : X9ECParametersHolder
	{
		...
		protected override X9ECParameters CreateParameters()
		{
			...
			BigInteger h = BigInteger.ValueOf(4L);
			ECCurve curve = ConfigureCurve(new F2mCurve(239, 36, FromHex("32010857077C5431123A46B808906756F543423E8D27877578125778AC76"), FromHex("790408F2EEDAF392B012EDEFB3392F30F4327C0CA3F31FC383C422AA8C16"), n, h));
	...
	internal class C2tnb239v2Holder : X9ECParametersHolder
	{
		...
		protected override X9ECParameters CreateParameters()
		{
			...
			BigInteger h = BigInteger.ValueOf(6L);
			ECCurve curve = ConfigureCurve(new F2mCurve(239, 36, FromHex("4230017757A767FAE42398569B746325D45313AF0766266479B75654E65F"), FromHex("5037EA654196CFF0CD82B2C14A2FCF2E3FF8775285B545722F03EACDB74B"), n, h));
	...
	internal class C2tnb239v3Holder : X9ECParametersHolder
	{
		...
		protected override X9ECParameters CreateParameters()
		{
			...
			ECCurve curve = ConfigureCurve(new F2mCurve(239, 36, FromHex("01238774666A67766D6676F778E676B66999176666E687666D8766C66A9F"), FromHex("6A941977BA9F6A435199ACFC51067ED587F519C5ECB541B8E44111DE1D40"), n, h));
	...
	internal class C2pnb272w1Holder : X9ECParametersHolder
	{
		...
		protected override X9ECParameters CreateParameters()
		{
			...
			ECCurve curve = ConfigureCurve(new F2mCurve(272, 1, 3, 56, FromHex("91A091F03B5FBA4AB2CCF49C4EDD220FB028712D42BE752B2C40094DBACDB586FB20"), FromHex("7167EFC92BB2E3CE7C8AAAFF34E12A9C557003D7C73A6FAF003F99F6CC8482E540F7"), n, h));
	...
	internal class C2pnb304w1Holder : X9ECParametersHolder
	{
		...
		protected override X9ECParameters CreateParameters()
		{
			...
			ECCurve curve = ConfigureCurve(new F2mCurve(304, 1, 2, 11, FromHex("FD0D693149A118F651E6DCE6802085377E5F882D1B510B44160074C1288078365A0396C8E681"), FromHex("BDDB97E555A50A908E43B01C798EA5DAA6788F1EA2794EFCF57166B8C14039601E55827340BE"), n, h));
	...
	internal class C2tnb359v1Holder : X9ECParametersHolder
	{
		...
		protected override X9ECParameters CreateParameters()
		{
			...
			ECCurve curve = ConfigureCurve(new F2mCurve(359, 68, FromHex("5667676A654B20754F356EA92017D946567C46675556F19556A04616B567D223A5E05656FB549016A96656A557"), FromHex("2472E2D0197C49363F1FE7F5B6DB075D52B6947D135D8CA445805D39BC345626089687742B6329E70680231988"), n, h));
	...
	internal class C2pnb368w1Holder : X9ECParametersHolder
	{
		...
		protected override X9ECParameters CreateParameters()
		{
			...
			ECCurve curve = ConfigureCurve(new F2mCurve(368, 1, 2, 85, FromHex("E0D2EE25095206F5E2A4F9ED229F1F256E79A0E2B455970D8D0D865BD94778C576D62F0AB7519CCD2A1A906AE30D"), FromHex("FC1217D4320A90452C760A58EDCD30C8DD069B3C34453837A34ED50CB54917E1C2112D84D164F444F8F74786046A"), n, h));
	...
	internal class C2tnb431r1Holder : X9ECParametersHolder
	{
		...
		protected override X9ECParameters CreateParameters()
		{
			...
			ECCurve curve = ConfigureCurve(new F2mCurve(431, 120, FromHex("1A827EF00DD6FC0E234CAF046C6A5D8A85395B236CC4AD2CF32A0CADBDC9DDF620B0EB9906D0957F6C6FEACD615468DF104DE296CD8F"), FromHex("10D9B4A3D9047D8B154359ABFB1B7F5485B04CEB868237DDC9DEDA982A679A5A919B626D4E50A8DD731B107A9962381FB5D807BF2618"), n, h));
