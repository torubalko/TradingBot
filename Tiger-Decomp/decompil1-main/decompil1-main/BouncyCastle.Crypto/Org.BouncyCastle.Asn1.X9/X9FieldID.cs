...
public class X9FieldID : Asn1Encodable
{
	...
	public X9FieldID(int m, int k1, int k2, int k3)
	{
		...
		if (k2 == 0)
		{
			...
			fieldIdParams.Add(X9ObjectIdentifiers.TPBasis, new DerInteger(k1));
		}
		else
		{
			if (k2 <= k1 || k3 <= k2)
			...
			fieldIdParams.Add(X9ObjectIdentifiers.PPBasis, new DerSequence(new DerInteger(k1), new DerInteger(k2), new DerInteger(k3)));
		}
