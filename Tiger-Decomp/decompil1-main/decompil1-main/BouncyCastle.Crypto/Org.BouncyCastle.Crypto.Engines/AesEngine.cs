...
public class AesEngine : IBlockCipher
{
	...
	private uint[][] GenerateWorkingKey(byte[] key, bool forEncryption)
	{
		...
		case 4:
		{
			...
			for (int l = 1; l <= 10; l++)
			{
				uint u3 = SubWord(Shift(t17, 8)) ^ AesEngine.rcon[l - 1];
				t14 ^= u3;
				W[l][0] = t14;
				t15 ^= t14;
				W[l][1] = t15;
	...
	private void EncryptBlock(byte[] input, int inOff, byte[] output, int outOff, uint[][] KW)
	{
		...
		{
			kw = KW[r4++];
			r5 = T0[t0 & 0xFF] ^ Shift(T0[(t1 >> 8) & 0xFF], 24) ^ Shift(T0[(t2 >> 16) & 0xFF], 16) ^ Shift(T0[(r3 >> 24) & 0xFF], 8) ^ kw[0];
			r6 = T0[t1 & 0xFF] ^ Shift(T0[(t2 >> 8) & 0xFF], 24) ^ Shift(T0[(r3 >> 16) & 0xFF], 16) ^ Shift(T0[(t0 >> 24) & 0xFF], 8) ^ kw[1];
			r7 = T0[t2 & 0xFF] ^ Shift(T0[(r3 >> 8) & 0xFF], 24) ^ Shift(T0[(t0 >> 16) & 0xFF], 16) ^ Shift(T0[(t1 >> 24) & 0xFF], 8) ^ kw[2];
			r3 = T0[r3 & 0xFF] ^ Shift(T0[(t0 >> 8) & 0xFF], 24) ^ Shift(T0[(t1 >> 16) & 0xFF], 16) ^ Shift(T0[(t2 >> 24) & 0xFF], 8) ^ kw[3];
			kw = KW[r4++];
			t0 = T0[r5 & 0xFF] ^ Shift(T0[(r6 >> 8) & 0xFF], 24) ^ Shift(T0[(r7 >> 16) & 0xFF], 16) ^ Shift(T0[(r3 >> 24) & 0xFF], 8) ^ kw[0];
			t1 = T0[r6 & 0xFF] ^ Shift(T0[(r7 >> 8) & 0xFF], 24) ^ Shift(T0[(r3 >> 16) & 0xFF], 16) ^ Shift(T0[(r5 >> 24) & 0xFF], 8) ^ kw[1];
			t2 = T0[r7 & 0xFF] ^ Shift(T0[(r3 >> 8) & 0xFF], 24) ^ Shift(T0[(r5 >> 16) & 0xFF], 16) ^ Shift(T0[(r6 >> 24) & 0xFF], 8) ^ kw[2];
			r3 = T0[r3 & 0xFF] ^ Shift(T0[(r5 >> 8) & 0xFF], 24) ^ Shift(T0[(r6 >> 16) & 0xFF], 16) ^ Shift(T0[(r7 >> 24) & 0xFF], 8) ^ kw[3];
		}
		kw = KW[r4++];
		r5 = T0[t0 & 0xFF] ^ Shift(T0[(t1 >> 8) & 0xFF], 24) ^ Shift(T0[(t2 >> 16) & 0xFF], 16) ^ Shift(T0[(r3 >> 24) & 0xFF], 8) ^ kw[0];
		r6 = T0[t1 & 0xFF] ^ Shift(T0[(t2 >> 8) & 0xFF], 24) ^ Shift(T0[(r3 >> 16) & 0xFF], 16) ^ Shift(T0[(t0 >> 24) & 0xFF], 8) ^ kw[1];
	...
	private void DecryptBlock(byte[] input, int inOff, byte[] output, int outOff, uint[][] KW)
	{
		...
		{
			kw = KW[r4--];
			r5 = Tinv0[t0 & 0xFF] ^ Shift(Tinv0[(r3 >> 8) & 0xFF], 24) ^ Shift(Tinv0[(t2 >> 16) & 0xFF], 16) ^ Shift(Tinv0[(t1 >> 24) & 0xFF], 8) ^ kw[0];
			r6 = Tinv0[t1 & 0xFF] ^ Shift(Tinv0[(t0 >> 8) & 0xFF], 24) ^ Shift(Tinv0[(r3 >> 16) & 0xFF], 16) ^ Shift(Tinv0[(t2 >> 24) & 0xFF], 8) ^ kw[1];
			r7 = Tinv0[t2 & 0xFF] ^ Shift(Tinv0[(t1 >> 8) & 0xFF], 24) ^ Shift(Tinv0[(t0 >> 16) & 0xFF], 16) ^ Shift(Tinv0[(r3 >> 24) & 0xFF], 8) ^ kw[2];
			r3 = Tinv0[r3 & 0xFF] ^ Shift(Tinv0[(t2 >> 8) & 0xFF], 24) ^ Shift(Tinv0[(t1 >> 16) & 0xFF], 16) ^ Shift(Tinv0[(t0 >> 24) & 0xFF], 8) ^ kw[3];
			kw = KW[r4--];
			t0 = Tinv0[r5 & 0xFF] ^ Shift(Tinv0[(r3 >> 8) & 0xFF], 24) ^ Shift(Tinv0[(r7 >> 16) & 0xFF], 16) ^ Shift(Tinv0[(r6 >> 24) & 0xFF], 8) ^ kw[0];
			t1 = Tinv0[r6 & 0xFF] ^ Shift(Tinv0[(r5 >> 8) & 0xFF], 24) ^ Shift(Tinv0[(r3 >> 16) & 0xFF], 16) ^ Shift(Tinv0[(r7 >> 24) & 0xFF], 8) ^ kw[1];
			t2 = Tinv0[r7 & 0xFF] ^ Shift(Tinv0[(r6 >> 8) & 0xFF], 24) ^ Shift(Tinv0[(r5 >> 16) & 0xFF], 16) ^ Shift(Tinv0[(r3 >> 24) & 0xFF], 8) ^ kw[2];
			r3 = Tinv0[r3 & 0xFF] ^ Shift(Tinv0[(r7 >> 8) & 0xFF], 24) ^ Shift(Tinv0[(r6 >> 16) & 0xFF], 16) ^ Shift(Tinv0[(r5 >> 24) & 0xFF], 8) ^ kw[3];
		}
		kw = KW[1];
		r5 = Tinv0[t0 & 0xFF] ^ Shift(Tinv0[(r3 >> 8) & 0xFF], 24) ^ Shift(Tinv0[(t2 >> 16) & 0xFF], 16) ^ Shift(Tinv0[(t1 >> 24) & 0xFF], 8) ^ kw[0];
		r6 = Tinv0[t1 & 0xFF] ^ Shift(Tinv0[(t0 >> 8) & 0xFF], 24) ^ Shift(Tinv0[(r3 >> 16) & 0xFF], 16) ^ Shift(Tinv0[(t2 >> 24) & 0xFF], 8) ^ kw[1];
		...
		r3 = Tinv0[r3 & 0xFF] ^ Shift(Tinv0[(t2 >> 8) & 0xFF], 24) ^ Shift(Tinv0[(t1 >> 16) & 0xFF], 16) ^ Shift(Tinv0[(t0 >> 24) & 0xFF], 8) ^ kw[3];
		kw = KW[0];
		C0 = (uint)(Si[r5 & 0xFF] ^ (s[(r3 >> 8) & 0xFF] << 8) ^ (s[(r7 >> 16) & 0xFF] << 16) ^ (Si[(r6 >> 24) & 0xFF] << 24)) ^ kw[0];
		C1 = (uint)(s[r6 & 0xFF] ^ (s[(r5 >> 8) & 0xFF] << 8) ^ (Si[(r3 >> 16) & 0xFF] << 16) ^ (s[(r7 >> 24) & 0xFF] << 24)) ^ kw[1];
		C2 = (uint)(s[r7 & 0xFF] ^ (Si[(r6 >> 8) & 0xFF] << 8) ^ (Si[(r5 >> 16) & 0xFF] << 16) ^ (s[(r3 >> 24) & 0xFF] << 24)) ^ kw[2];
		int n = Si[r3 & 0xFF] ^ (s[(r7 >> 8) & 0xFF] << 8) ^ (s[(r6 >> 16) & 0xFF] << 16) ^ (s[(r5 >> 24) & 0xFF] << 24) ^ (int)kw[3];
		Pack.UInt32_To_LE(C0, output, outOff);
		Pack.UInt32_To_LE(C1, output, outOff + 4);
		Pack.UInt32_To_LE(C2, output, outOff + 8);
		Pack.UInt32_To_LE((uint)n, output, outOff + 12);
