...
internal class SecP160R1Point : AbstractFpPoint
{
	...
	public override ECPoint Add(ECPoint b)
	{
		...
		ECCurve curve = Curve;
		SecP160R1FieldElement X1 = (SecP160R1FieldElement)base.RawXCoord;
		SecP160R1FieldElement Y1 = (SecP160R1FieldElement)base.RawYCoord;
		SecP160R1FieldElement X2 = (SecP160R1FieldElement)b.RawXCoord;
		SecP160R1FieldElement Y2 = (SecP160R1FieldElement)b.RawYCoord;
		SecP160R1FieldElement Z1 = (SecP160R1FieldElement)base.RawZCoords[0];
		...
		{
			S3 = t4;
			SecP160R1Field.Square(Z2.x, S3);
			U3 = tt1;
			SecP160R1Field.Multiply(S3, X1.x, U3);
			SecP160R1Field.Multiply(S3, Z2.x, S3);
			SecP160R1Field.Multiply(S3, Y1.x, S3);
		}
		uint[] H = Nat160.Create();
		SecP160R1Field.Subtract(U3, U2, H);
		uint[] R = t2;
		SecP160R1Field.Subtract(S3, S2, R);
		if (Nat160.IsZero(H))
		{
			if (Nat160.IsZero(R))
			{
		...
		uint[] V = t3;
		SecP160R1Field.Multiply(HSquared, U3, V);
		...
		return new SecP160R1Point(curve, X3, Y3, zs, base.IsCompressed);
	}
	...
	public override ECPoint Twice()
	{
		...
		SecP160R1Field.Reduce32(Nat.ShiftUpBits(5, S, 2, 0u), S);
		SecP160R1Field.Reduce32(Nat.ShiftUpBits(5, T, 3, 0u, t1), t1);
		...
		return new SecP160R1Point(curve, X3, Y3, new ECFieldElement[1] { Z3 }, base.IsCompressed);
	}
