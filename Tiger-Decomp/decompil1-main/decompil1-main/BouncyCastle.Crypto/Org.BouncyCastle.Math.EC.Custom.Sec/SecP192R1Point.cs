...
internal class SecP192R1Point : AbstractFpPoint
{
	...
	public override ECPoint Add(ECPoint b)
	{
		...
		ECCurve curve = Curve;
		SecP192R1FieldElement X1 = (SecP192R1FieldElement)base.RawXCoord;
		SecP192R1FieldElement Y1 = (SecP192R1FieldElement)base.RawYCoord;
		SecP192R1FieldElement X2 = (SecP192R1FieldElement)b.RawXCoord;
		SecP192R1FieldElement Y2 = (SecP192R1FieldElement)b.RawYCoord;
		SecP192R1FieldElement Z1 = (SecP192R1FieldElement)base.RawZCoords[0];
		...
		{
			S3 = t4;
			SecP192R1Field.Square(Z2.x, S3);
			U3 = tt1;
			SecP192R1Field.Multiply(S3, X1.x, U3);
			SecP192R1Field.Multiply(S3, Z2.x, S3);
			SecP192R1Field.Multiply(S3, Y1.x, S3);
		}
		uint[] H = Nat192.Create();
		SecP192R1Field.Subtract(U3, U2, H);
		uint[] R = t2;
		SecP192R1Field.Subtract(S3, S2, R);
		if (Nat192.IsZero(H))
		{
			if (Nat192.IsZero(R))
			{
		...
		uint[] V = t3;
		SecP192R1Field.Multiply(HSquared, U3, V);
		...
		return new SecP192R1Point(curve, X3, Y3, zs, base.IsCompressed);
	}
	...
	public override ECPoint Twice()
	{
		...
		SecP192R1Field.Reduce32(Nat.ShiftUpBits(6, S, 2, 0u), S);
		SecP192R1Field.Reduce32(Nat.ShiftUpBits(6, T, 3, 0u, t1), t1);
		...
		return new SecP192R1Point(curve, X3, Y3, new ECFieldElement[1] { Z3 }, base.IsCompressed);
	}
