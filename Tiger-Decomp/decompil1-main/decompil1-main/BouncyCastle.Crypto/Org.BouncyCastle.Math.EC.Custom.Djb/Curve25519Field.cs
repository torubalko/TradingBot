...
internal class Curve25519Field
{
	...
	{
		uint xx7 = xx[7];
		Nat.ShiftUpBit(8, xx, 8, xx7, z, 0);
		uint c = Nat256.MulByWordAddTo(19u, xx, z) << 1;
		uint z7 = z[7];
		c += (z7 >> 31) - (xx7 >> 31);
		z7 &= 0x7FFFFFFF;
		if ((z[7] = z7 + Nat.AddWordTo(7, c * 19, z)) >= int.MaxValue && Nat256.Gte(z, P))
		{
			SubPFrom(z);
		}
	}
