...
public sealed class GeneratorUtilities
{
	...
	public static CipherKeyGenerator GetKeyGenerator(string algorithm)
	{
		...
		if (defaultKeySize == -1)
		{
			throw new SecurityUtilityException("KeyGenerator " + algorithm + " (" + canonicalName + ") not supported.");
		}
	...
	public static IAsymmetricCipherKeyPairGenerator GetKeyPairGenerator(string algorithm)
	{
		...
		default:
			throw new SecurityUtilityException("KeyPairGenerator " + algorithm + " (" + canonicalName + ") not supported.");
		}
	}
