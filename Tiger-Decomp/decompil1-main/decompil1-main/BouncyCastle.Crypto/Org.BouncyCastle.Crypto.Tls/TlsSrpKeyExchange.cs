...
public class TlsSrpKeyExchange : AbstractTlsKeyExchange
{
	...
	public override void ProcessServerKeyExchange(Stream input)
	{
		...
		mSrpGroup = new Srp6GroupParameters(srpParams.N, srpParams.G);
		if (!mGroupVerifier.Accept(mSrpGroup))
		{
			throw new TlsFatalAlert(71);
		}
		mSrpSalt = srpParams.S;
		try
		{
			mSrpPeerCredentials = Srp6Utilities.ValidatePublicValue(mSrpGroup.N, srpParams.B);
		}
