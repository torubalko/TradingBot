...
public sealed class SecNamedCurves
{
	internal class Secp112r1Holder : X9ECParametersHolder
	{
		...
		protected override X9ECParameters CreateParameters()
		{
			...
			ECCurve curve = ConfigureCurve(new FpCurve(q, a, b, n, h));
	...
	internal class Secp160k1Holder : X9ECParametersHolder
	{
		...
		protected override X9ECParameters CreateParameters()
		{
			...
			BigInteger h = BigInteger.One;
			GlvTypeBParameters glv = new GlvTypeBParameters(new BigInteger("9ba48cba5ebcb9b6bd33b92830b2a2e0e192f10a", 16), new BigInteger("c39c6c3b3a36d7701b9c71a1f5804ae5d0003f4", 16), new ScalarSplitParameters(new BigInteger[2]
			{
	...
	internal class Secp192k1Holder : X9ECParametersHolder
	{
		...
		protected override X9ECParameters CreateParameters()
		{
			...
			BigInteger h = BigInteger.One;
			GlvTypeBParameters glv = new GlvTypeBParameters(new BigInteger("bb85691939b869c1d087f601554b96b80cb4f55b35f433c2", 16), new BigInteger("3d84f26c12238d7b4f3d516613c1759033b1a5800175d0b1", 16), new ScalarSplitParameters(new BigInteger[2]
			{
	...
	internal class Secp224k1Holder : X9ECParametersHolder
	{
		...
		protected override X9ECParameters CreateParameters()
		{
			...
			BigInteger h = BigInteger.One;
			GlvTypeBParameters glv = new GlvTypeBParameters(new BigInteger("fe0e87005b4e83761908c5131d552a850b3f58b749c37cf5b84d6768", 16), new BigInteger("60dcd2104c4cbc0be6eeefc2bdd610739ec34e317f9b33046c9e4788", 16), new ScalarSplitParameters(new BigInteger[2]
			{
	...
	internal class Secp256k1Holder : X9ECParametersHolder
	{
		...
		protected override X9ECParameters CreateParameters()
		{
			...
			BigInteger h = BigInteger.One;
			GlvTypeBParameters glv = new GlvTypeBParameters(new BigInteger("7ae96a2b657c07106e64479eac3434e99cf0497512f58995c1396c28719501ee", 16), new BigInteger("5363ad4cc05c30e0a5261c028812645a122e22ea20816678df02967c1b23bd72", 16), new ScalarSplitParameters(new BigInteger[2]
			{
	...
	internal class Sect113r1Holder : X9ECParametersHolder
	{
		...
		protected override X9ECParameters CreateParameters()
		{
			...
			F2mCurve curve = new F2mCurve(113, 9, a, b, n, h);
	...
	internal class Sect131r1Holder : X9ECParametersHolder
	{
		...
		protected override X9ECParameters CreateParameters()
		{
			...
			BigInteger h = BigInteger.ValueOf(2L);
			F2mCurve curve = new F2mCurve(131, 2, 3, 8, a, b, n, h);
	...
	internal class Sect163k1Holder : X9ECParametersHolder
	{
		...
		protected override X9ECParameters CreateParameters()
		{
			...
			BigInteger h = BigInteger.ValueOf(2L);
			F2mCurve curve = new F2mCurve(163, 3, 6, 7, a, b, n, h);
	...
	internal class Sect193r1Holder : X9ECParametersHolder
	{
		...
		protected override X9ECParameters CreateParameters()
		{
			...
			BigInteger h = BigInteger.ValueOf(2L);
			F2mCurve curve = new F2mCurve(193, 15, a, b, n, h);
	...
	internal class Sect233k1Holder : X9ECParametersHolder
	{
		...
		protected override X9ECParameters CreateParameters()
		{
			...
			BigInteger h = BigInteger.ValueOf(4L);
			F2mCurve curve = new F2mCurve(233, 74, a, b, n, h);
	...
	internal class Sect239k1Holder : X9ECParametersHolder
	{
		...
		protected override X9ECParameters CreateParameters()
		{
			...
			BigInteger h = BigInteger.ValueOf(4L);
			F2mCurve curve = new F2mCurve(239, 158, a, b, n, h);
	...
	internal class Sect283k1Holder : X9ECParametersHolder
	{
		...
		protected override X9ECParameters CreateParameters()
		{
			...
			BigInteger h = BigInteger.ValueOf(4L);
			F2mCurve curve = new F2mCurve(283, 5, 7, 12, a, b, n, h);
	...
	internal class Sect409k1Holder : X9ECParametersHolder
	{
		...
		protected override X9ECParameters CreateParameters()
		{
			...
			BigInteger h = BigInteger.ValueOf(4L);
			F2mCurve curve = new F2mCurve(409, 87, a, b, n, h);
	...
	internal class Sect571k1Holder : X9ECParametersHolder
	{
		...
		protected override X9ECParameters CreateParameters()
		{
			...
			BigInteger h = BigInteger.ValueOf(4L);
			F2mCurve curve = new F2mCurve(571, 2, 5, 10, a, b, n, h);
