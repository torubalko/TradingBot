...
public class ISO9797Alg3Mac : IMac
{
	...
	public void Init(ICipherParameters parameters)
	{
		...
		KeyParameter kp = ((!(parameters is KeyParameter)) ? ((KeyParameter)((ParametersWithIV)parameters).Parameters) : ((KeyParameter)parameters));
		...
		{
			cipher.Init(forEncryption: true, new ParametersWithIV(key1, ((ParametersWithIV)parameters).GetIV()));
		}
		else
		{
			cipher.Init(forEncryption: true, key1);
		}
	}
