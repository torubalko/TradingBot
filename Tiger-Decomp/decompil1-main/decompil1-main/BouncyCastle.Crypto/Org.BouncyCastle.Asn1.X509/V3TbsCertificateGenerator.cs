...
public class V3TbsCertificateGenerator
{
	...
	public TbsCertificateStructure GenerateTbsCertificate()
	{
		...
		DerSequence validity = new DerSequence(startDate, endDate);
		Asn1EncodableVector v = new Asn1EncodableVector(version, serialNumber, signature, issuer, validity);
		if (subject != null)
		{
			v.Add(subject);
		}
		...
		{
			v.Add(new DerTaggedObject(explicitly: false, 1, issuerUniqueID));
		}
		if (subjectUniqueID != null)
		{
			v.Add(new DerTaggedObject(explicitly: false, 2, subjectUniqueID));
		}
		if (extensions != null)
		{
