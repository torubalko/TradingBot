...
public class X509Extensions : Asn1Encodable
{
	...
	private X509Extensions(Asn1Sequence seq)
	{
		...
		{
			Asn1Sequence s = Asn1Sequence.GetInstance(item.ToAsn1Object());
			...
			bool isCritical = s.Count == 3 && DerBoolean.GetInstance(s[1].ToAsn1Object()).IsTrue;
	...
	private DerObjectIdentifier[] GetExtensionOids(bool isCritical)
	{
		...
		foreach (DerObjectIdentifier oid in ordering)
		{
			if (((X509Extension)extensions[oid]).IsCritical == isCritical)
			{
				oids.Add(oid);
			}
		}
