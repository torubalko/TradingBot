...
public class AuthorityKeyIdentifier : Asn1Encodable
{
	...
	protected internal AuthorityKeyIdentifier(Asn1Sequence seq)
	{
		...
		{
			Asn1TaggedObject obj = Asn1TaggedObject.GetInstance(item);
			switch (obj.TagNo)
			{
			case 0:
				keyidentifier = Asn1OctetString.GetInstance(obj, isExplicit: false);
				break;
			case 1:
				certissuer = GeneralNames.GetInstance(obj, explicitly: false);
				break;
			case 2:
				certserno = DerInteger.GetInstance(obj, isExplicit: false);
				break;
			default:
