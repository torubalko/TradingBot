...
public class Holder : Asn1Encodable
{
	...
	private Holder(Asn1Sequence seq)
	{
		...
		for (int i = 0; i != seq.Count; i++)
		{
			...
			{
			case 0:
				baseCertificateID = IssuerSerial.GetInstance(tObj, explicitly: false);
				break;
			case 1:
				entityName = GeneralNames.GetInstance(tObj, explicitly: false);
				break;
			case 2:
				objectDigestInfo = ObjectDigestInfo.GetInstance(tObj, isExplicit: false);
				break;
			default:
				throw new ArgumentException("unknown tag in Holder");
			}
	...
	public override Asn1Object ToAsn1Object()
	{
		...
		if (entityName != null)
		{
			return new DerTaggedObject(explicitly: true, 1, entityName);
		}
		return new DerTaggedObject(explicitly: true, 0, baseCertificateID);
	}
}
