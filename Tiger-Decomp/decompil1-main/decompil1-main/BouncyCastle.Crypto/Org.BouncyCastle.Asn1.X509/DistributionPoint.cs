...
public class DistributionPoint : Asn1Encodable
{
	...
	private DistributionPoint(Asn1Sequence seq)
	{
		for (int i = 0; i != seq.Count; i++)
		{
			...
			{
			case 0:
				distributionPoint = DistributionPointName.GetInstance(t, explicitly: true);
				break;
			case 1:
				reasons = new ReasonFlags(DerBitString.GetInstance(t, isExplicit: false));
				break;
			case 2:
				cRLIssuer = GeneralNames.GetInstance(t, explicitly: false);
				break;
			}
		}
	}
