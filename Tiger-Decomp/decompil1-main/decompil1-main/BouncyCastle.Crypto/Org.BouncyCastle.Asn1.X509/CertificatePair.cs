...
public class CertificatePair : Asn1Encodable
{
	...
	private CertificatePair(Asn1Sequence seq)
	{
		...
		{
			Asn1TaggedObject o = Asn1TaggedObject.GetInstance(item);
			if (o.TagNo == 0)
			{
				forward = X509CertificateStructure.GetInstance(o, explicitly: true);
				continue;
			}
			if (o.TagNo == 1)
			{
				reverse = X509CertificateStructure.GetInstance(o, explicitly: true);
				continue;
			}
