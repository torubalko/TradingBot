...
internal abstract class Nat448
{
	...
	public static void Mul(uint[] x, uint[] y, uint[] zz)
	{
		...
		uint c22 = c21 + Nat224.AddTo(zz, 0, zz, 7, 0u);
		c21 += Nat224.AddTo(zz, 21, zz, 14, c22);
		uint[] dx = Nat224.Create();
		uint[] dy = Nat224.Create();
		bool neg = Nat224.Diff(x, 7, x, 0, dx, 0) != Nat224.Diff(y, 7, y, 0, dy, 0);
		uint[] tt = Nat224.CreateExt();
		Nat224.Mul(dx, dy, tt);
		c21 += (uint)(neg ? ((int)Nat.AddTo(14, tt, 0, zz, 7)) : Nat.SubFrom(14, tt, 0, zz, 7));
