...
public class TrustAnchor
{
	...
	public override string ToString()
	{
		...
		if (pubKey != null)
		{
			sb.Append("  Trusted CA Public Key: ").Append(pubKey).Append(nl);
			sb.Append("  Trusted CA Issuer Name: ").Append(caName).Append(nl);
		}
		else
		{
			sb.Append("  Trusted CA cert: ").Append(TrustedCert).Append(nl);
		}
		if (nc != null)
		{
