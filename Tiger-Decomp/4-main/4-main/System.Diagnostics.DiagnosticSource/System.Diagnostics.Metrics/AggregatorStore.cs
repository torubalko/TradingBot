...
internal struct AggregatorStore<TAggregator> where TAggregator : Aggregator
{
	...
	public TAggregator GetAggregator(System.ReadOnlySpan<KeyValuePair<string, object>> labels)
	{
	...
	private TAggregator GetAggregatorSlow(System.ReadOnlySpan<KeyValuePair<string, object>> labels)
	{
