...
public sealed class Histogram<T> : Instrument<T> where T : struct
{
	...
	public void Record(T value, System.ReadOnlySpan<KeyValuePair<string, object?>> tags)
	{
	...
	{
		RecordMeasurement(value, System.Span<KeyValuePair<string, object>>.op_Implicit(MemoryExtensions.AsSpan<KeyValuePair<string, object>>(tags)));
	}
