...
public struct TagList : IList<KeyValuePair<string, object?>>, ICollection<KeyValuePair<string, object?>>, IEnumerable<KeyValuePair<string, object?>>, IEnumerable, IReadOnlyList<KeyValuePair<string, object?>>, IReadOnlyCollection<KeyValuePair<string, object?>>
{
	...
	public unsafe TagList(System.ReadOnlySpan<KeyValuePair<string, object?>> tagList)
	{
		...
		{
		case 8:
			Tag8 = System.Runtime.CompilerServices.Unsafe.Read<KeyValuePair<string, object>>((void*)tagList[7]);
			goto case 7;
		case 7:
			Tag7 = System.Runtime.CompilerServices.Unsafe.Read<KeyValuePair<string, object>>((void*)tagList[6]);
			goto case 6;
		case 6:
			Tag6 = System.Runtime.CompilerServices.Unsafe.Read<KeyValuePair<string, object>>((void*)tagList[5]);
			goto case 5;
		case 5:
			Tag5 = System.Runtime.CompilerServices.Unsafe.Read<KeyValuePair<string, object>>((void*)tagList[4]);
			goto case 4;
		case 4:
			Tag4 = System.Runtime.CompilerServices.Unsafe.Read<KeyValuePair<string, object>>((void*)tagList[3]);
			goto case 3;
		case 3:
			Tag3 = System.Runtime.CompilerServices.Unsafe.Read<KeyValuePair<string, object>>((void*)tagList[2]);
			goto case 2;
		case 2:
			Tag2 = System.Runtime.CompilerServices.Unsafe.Read<KeyValuePair<string, object>>((void*)tagList[1]);
			goto case 1;
		case 1:
			Tag1 = System.Runtime.CompilerServices.Unsafe.Read<KeyValuePair<string, object>>((void*)tagList[0]);
			break;
		case 0:
			break;
		default:
			_overflowTags = new KeyValuePair<string, object>[_tagsCount + 8];
			tagList.CopyTo(System.Span<KeyValuePair<string, object>>.op_Implicit(_overflowTags));
			break;
		}
	}
	...
	public readonly void CopyTo(System.Span<KeyValuePair<string, object?>> tags)
	{
		...
		if (_overflowTags != null)
		{
			MemoryExtensions.AsSpan<KeyValuePair<string, object>>(_overflowTags, 0, _tagsCount).CopyTo(tags);
			return;
		}
		switch (_tagsCount)
		{
	...
	public readonly void CopyTo(KeyValuePair<string, object?>[] array, int arrayIndex)
	{
		...
		CopyTo(MemoryExtensions.AsSpan<KeyValuePair<string, object>>(array, arrayIndex));
	}
