...
public class Effect : Properties
{
	...
	{
		using Image input = effect.Output;
	...
	public static explicit operator Effect(IntPtr nativePtr)
	{
	...
	public unsafe void SetInput(int index, Image input, RawBool invalidate)
	{
		...
		zero = CppObject.ToCallbackPtr<Image>(input);
		((delegate* unmanaged[Stdcall]<void*, int, void*, RawBool, void>)(*(IntPtr*)((nint)(*(IntPtr*)_nativePointer) + (nint)14 * (nint)sizeof(void*))))(_nativePointer, index, (void*)zero, invalidate);
	}

	internal unsafe void SetInputCount(int inputCount)
	{
		((Result)((delegate* unmanaged[Stdcall]<void*, int, int>)(*(IntPtr*)((nint)(*(IntPtr*)_nativePointer) + (nint)15 * (nint)sizeof(void*))))(_nativePointer, inputCount)).CheckError();
	}

	public unsafe Image GetInput(int index)
	{
		IntPtr zero = IntPtr.Zero;
		((delegate* unmanaged[Stdcall]<void*, int, void*, void>)(*(IntPtr*)((nint)(*(IntPtr*)_nativePointer) + (nint)16 * (nint)sizeof(void*))))(_nativePointer, index, &zero);
		if (zero != IntPtr.Zero)
		{
			return new Image(zero);
		}
		return null;
	}
	...
	{
		return ((delegate* unmanaged[Stdcall]<void*, int>)(*(IntPtr*)((nint)(*(IntPtr*)_nativePointer) + (nint)17 * (nint)sizeof(void*))))(_nativePointer);
	}

	internal unsafe void GetOutput(out Image outputImage)
	{
		IntPtr zero = IntPtr.Zero;
		((delegate* unmanaged[Stdcall]<void*, void*, void>)(*(IntPtr*)((nint)(*(IntPtr*)_nativePointer) + (nint)18 * (nint)sizeof(void*))))(_nativePointer, &zero);
		if (zero != IntPtr.Zero)
		{
