...
internal class X3DAudio17
{
	...
	[DllImport("X3DAudio1_7.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "X3DAudioCalculate")]
	...
	[DllImport("X3DAudio1_7.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "X3DAudioInitialize")]
